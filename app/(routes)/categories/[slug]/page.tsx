        ...
        <div className="container mx-auto">
          ...
          <div className="glass-card p-5 mb-6 rounded-xl">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              <button 
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${showInStock ? 'bg-primary-500 text-white' : 'bg-white/10 hover:bg-white/20 text-gray-700 dark:text-gray-200'}`}
                onClick={() => setShowInStock(!showInStock)}
              >
                有货
              </button>
              <button 
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${showFeatured ? 'bg-primary-500 text-white' : 'bg-white/10 hover:bg-white/20 text-gray-700 dark:text-gray-200'}`}
                onClick={() => setShowFeatured(!showFeatured)}
              >
                特色商品
              </button>
              <button 
                className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${showOnSale ? 'bg-primary-500 text-white' : 'bg-white/10 hover:bg-white/20 text-gray-700 dark:text-gray-200'}`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="flex justify-end">
                <Link 
                  href="/categories" 
                  className="px-3 py-2 border border-primary-500 text-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/20 font-medium rounded-lg transition-colors flex items-center text-sm"
                >
                  <FaArrowLeft className="mr-2" /> 返回分类
                </Link>
              </div>
            </div>
